...
INSERT INTO vocabulary (level_number, korean, english, category) VALUES
  (1, '한국',   'Korea',              'noun'),
  (1, '도시',   'city',               'noun'),
  (1, '이름',   'name',               'noun'),
  (1, '저',     'I (formal)',         'pronoun'),
  (1, '나',     'I (informal)',       'pronoun'),
  (1, '남자',   'man',                'noun'),
  (1, '여자',   'woman',              'noun'),
  (1, '이',     'this',               'determiner'),
  (1, '그',     'that',               'determiner'),
  (1, '저',     'that (far away)',    'determiner'),
  (1, '것',     'thing',              'noun'),
  (1, '이것',   'this thing',         'pronoun'),
  (1, '그것',   'that thing',         'pronoun'),
  (1, '저것',   'that thing (far away)', 'pronoun'),
  (1, '의자',   'chair',              'noun'),
  (1, '탁자',   'table',              'noun'),
  (1, '선생님', 'teacher',            'noun'),
  (1, '침대',   'bed',                'noun'),
